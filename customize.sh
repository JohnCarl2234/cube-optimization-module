...
ui_print ""
ui_print "* Cube Memory Management Optimization"
ui_print "* By @rei_ryota"
ui_print "* Memory managment for Exynos chipsets"
ui_print "* 0.1.000 (initial release) "
ui_print "* Version codename: raine"
ui_print ""
